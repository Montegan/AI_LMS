    ...
    <>
      ...
      >
        ...
        <button
          ...
          className="absolute h-8 w-8 rounded-full bg-red-500 hover:bg-red-600 text-white font-bold top-[5px] right-[5px] flex items-center justify-center transition-colors"
        >
          X
        </button>
        ...
        <div className=" bg-[#4b4b4b96] p-4 flex gap-2 rounded-md items-center justify-start w-full">
          ...
          {file && (
            <button
              className="self-end w-fit bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded transition-colors"
        ...
        {/* <div className=" bg-[#4b4b4b96] text-white flex flex-col gap-2 rounded-md p-2">
          ...
          <div className="w-full flex gap-2 ">
            ...
            />
            <button
              className="w-fit bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded transition-colors"

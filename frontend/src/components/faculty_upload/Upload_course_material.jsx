  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      const storageRef = ref(
        storage,
        `materials/${selectedCourse}/week_${selectedWeek}/${fileName}`
      );
      ...
      >
        ...
        <div className="space-y-6">
          ...
          >
            ...
            >
              <strong>Note:</strong> Uploaded materials will be immediately
              available to students enrolled in the selected course.
            </p>
          </div>
        </div>
      </div>
